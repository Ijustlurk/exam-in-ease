    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin-access')): ?>
        ...
        <div id="mainContent" class="main">
            ...
            <div class="dashboard-cards">
                <div class="stat-card">
                    <h2><?php echo e(number_format($totalExams ?? 0)); ?></h2>
                    <p>Exams</p>
                </div>
                <div class="stat-card">
                    <h2><?php echo e(number_format($totalStudents ?? 0)); ?></h2>
                    <p>Students</p>
                </div>
                <div class="stat-card">
                    <h2><?php echo e(number_format($totalSubjects ?? 0)); ?></h2>
                    <p>Subjects</p>
                </div>
                <div class="stat-card">
                    <h2><?php echo e(number_format($totalActiveUsers ?? 0)); ?></h2>
                    <p>Active Users</p>
                </div>
            </div>
                    ...
                    <div class="exam-card">
                        <div class="exam-card-content">
                            ...
                            <div class="exam-details">
                                <h5><?php echo e($exam->exam_title); ?></h5>
                                <p><strong>Collaborators:</strong> <?php echo e($exam->user->name); ?></p>
                                <p><strong>Subject:</strong> <?php echo e($exam->subject->subject_name); ?></p>
                                <p><strong>Department:</strong> Computer Science</p>
                                <p><strong>Classes Undertaking:</strong> 1A Comp Prog, 1B Comp Prog, and others</p>
                                <p><strong>Semester:</strong> <?php echo e($exam->semester); ?></p>
                                <p><strong>Term:</strong> Midterm</p>
                            </div>
                        </div>
                        <button class="monitor-btn" onclick="window.location.href='<?php echo e(route('admin.monitor.show', $exam->exam_id)); ?>'">
...
<?php echo $__env->make('layouts.Admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\exam1\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>