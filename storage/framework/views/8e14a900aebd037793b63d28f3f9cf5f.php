    ...
    <div class="table-container">
        <table class="exams-table">
            ...
            <tbody id="examsTableBody">
                ...
                <tr>
                    <td>
                        <input type="checkbox" class="exam-checkbox" value="<?php echo e($exam->exam_id); ?>">
                    </td>
                    <td>
                        <div class="exam-name"><?php echo e($exam->exam_title); ?></div>
                        <div class="teacher-name"><?php echo e($exam->teacher_name); ?></div>
                    </td>
                    <td><?php echo e($exam->subject->subject_name); ?></td>
                    <td><?php echo e($exam->classes_display ?: 'No classes assigned'); ?></td>
                    <td>
                        <span class="status-badge status-<?php echo e(strtolower($exam->status_display)); ?>">
                            <?php echo e($exam->status_display); ?>

                        </span>
                    </td>
                    <td>
                        <div class="actions-cell">
                            <a href="<?php echo e(route('admin.exam-statistics.show', $exam->exam_id)); ?>" class="action-btn">
                                <i class="fas fa-search"></i>
                                <span>View</span>
                            </a>
                            <?php if($exam->status === 'archived'): ?>
                            <a href="<?php echo e(route('admin.exam-statistics.stats', $exam->exam_id)); ?>" class="action-btn">
        ...
        <div class="pagination-wrapper">
            ...
            <?php else: ?>
                <a href="<?php echo e($exams->previousPageUrl()); ?>" class="pagination-btn">Prev</a>
            <?php endif; ?>

            
            <?php $__currentLoopData = range(1, $exams->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($page == $exams->currentPage()): ?>
                    <button class="pagination-btn active"><?php echo e($page); ?></button>
                <?php else: ?>
                    <a href="<?php echo e($exams->url($page)); ?>" class="pagination-btn"><?php echo e($page); ?></a>
                <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

            
            <?php if($exams->hasMorePages()): ?>
                <a href="<?php echo e($exams->nextPageUrl()); ?>" class="pagination-btn">Next</a>
            <?php else: ?>
...
<?php endif; ?>
<?php echo $__env->make('layouts.Admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\exam1\resources\views/admin/exam-statistics/index.blade.php ENDPATH**/ ?>