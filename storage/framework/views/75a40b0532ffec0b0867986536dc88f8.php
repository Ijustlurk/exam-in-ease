    ...
    <div class="table-container">
        <div class="table-scroll-wrapper">
            <table class="subjects-table">
                ...
                <tr>
                    <td><span class="subject-code"><?php echo e($subject->subject_code); ?></span></td>
                    <td class="subject-name"><?php echo e($subject->subject_name); ?></td>
                    <td><?php echo e($subject->semester); ?></td>
                    <td><?php echo e($subject->classes_count); ?> class(es)</td>
                    <td>
                        <div class="actions-cell">
                            <button class="action-btn" onclick="editSubject(<?php echo e($subject->subject_id); ?>)">
                                <i class="fas fa-edit"></i> Edit
                            </button>
                            <button class="action-btn" onclick="deleteSubject(<?php echo e($subject->subject_id); ?>, '<?php echo e($subject->subject_name); ?>', <?php echo e($subject->classes_count); ?>)">
...
<script>
    ...
    document.getElementById('newSubjectForm').addEventListener('submit', function(e) {
        ...
        fetch('<?php echo e(route("admin.manage-subject.store")); ?>', {
            method: 'POST',
            body: formData,
            headers: {
...
<?php echo $__env->make('layouts.Admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\exam1\resources\views/admin/manage-subject/index.blade.php ENDPATH**/ ?>