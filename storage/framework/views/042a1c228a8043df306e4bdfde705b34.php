...
<?php $__env->startSection('content'); ?>
            ...
            <div class="table-scroll-wrapper">
                <table class="classes-table">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="<?php echo e($class->status == 'Archived' ? 'archived' : ''); ?>" data-status="<?php echo e($class->status); ?>">
                            <td class="class-name"><?php echo e($class->title); ?></td>
                            <td><?php echo e($class->teacher ? $class->teacher->first_name . ' ' . $class->teacher->last_name : 'No Teacher Assigned'); ?>

                            </td>
                            <td><?php echo e($class->subject->subject_name); ?></td>
                            <td><?php echo e($class->students->count()); ?></td>
                            <td>
                                <div class="actions-cell">
                                    <button class="action-btn"
                                        onclick="manageStudents(<?php echo e($class->class_id); ?>, '<?php echo e($class->title); ?>')">
                                        <i class="fas fa-users"></i> Manage Students
                                    </button>
                                    <?php if($class->status == 'Active'): ?>
                                        <button class="action-btn" onclick="archiveClass(<?php echo e($class->class_id); ?>)">
                                            <i class="fas fa-archive"></i> Archive
                                        </button>
                                    <?php else: ?>
                                        <button class="action-btn" onclick="unarchiveClass(<?php echo e($class->class_id); ?>)">
                                            <i class="fas fa-box-open"></i> Unarchive
                                        </button>
                                    <?php endif; ?>
                                    <button class="action-btn" onclick="deleteClass(<?php echo e($class->class_id); ?>)">
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <select class="form-select" name="subject_id" required
                                        ...
                                        <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($subject->subject_id); ?>"><?php echo e($subject->subject_name); ?>
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <select class="form-select" name="teacher_id" required
                                        ...
                                        <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($teacher->user_id); ?>"><?php echo e($teacher->first_name); ?>

                                                <?php echo e($teacher->last_name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
    ...
    <script>
        ...
        document.getElementById('newClassForm').addEventListener('submit', function(e) {
            ...
            fetch('<?php echo e(route('admin.manage-classes.store')); ?>', {
                    method: 'POST',
                    body: formData,
                    headers: {
...
<?php echo $__env->make('layouts.Admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\exam1\resources\views/admin/manage-classes/index.blade.php ENDPATH**/ ?>