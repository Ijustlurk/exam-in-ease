    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                <a href="<?php echo e(route('dashboard')); ?>" class="text-dark fs-2">
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    <div x-show="open" 
                        ...
                        <div class="p-4 border-b border-gray-200 flex items-center justify-between">
                            ...
                            <?php if($unreadCount > 0): ?>
                                <a href="<?php echo e(route('instructor.notifications.mark-all-read')); ?>" 
                        ...
                        <div style="max-height: 180px; overflow-y: auto;">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <a href="<?php echo e(route('instructor.notifications.show', $notification->notification_id)); ?>" 
                                   class="block p-3 hover:bg-gray-50 border-b border-gray-100 <?php echo e(!$notification->is_read ? 'bg-blue-50' : ''); ?>"
                                   onclick="event.preventDefault(); markAsReadAndRedirect(<?php echo e($notification->notification_id); ?>, '<?php echo e($notification->data['url'] ?? route('dashboard')); ?>');">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <p class="text-xs text-gray-400 mt-1"><?php echo e($notification->time_ago); ?></p>
                                        </div>
                        ...
                        <?php if($notifications->count() > 0): ?>
                            <div class="p-3 border-t border-gray-200 text-center">
                                <a href="<?php echo e(route('instructor.notifications.index')); ?>" class="text-sm text-blue-600 hover:text-blue-800">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Logged in as <?php echo e(Auth::user()->roles[0]->name); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal68cb1971a2b92c9735f83359058f7108)): ?>
<?php $attributes = $__attributesOriginal68cb1971a2b92c9735f83359058f7108; ?>
<?php unset($__attributesOriginal68cb1971a2b92c9735f83359058f7108); ?>
...
<!-- Sidebar -->
<?php if(!request()->routeIs('instructor.exams.create')): ?>
<div class="sidebar shadow border ms-3 rounded" id="sidebar">
    ...
    <a href="<?php echo e(route('instructor.exam-statistics.index')); ?>" class="nav-item <?php echo e(request()->routeIs('instructor.exam-statistics.*') ? 'active' : ''); ?>">
...
<!-- Main Content -->
<div class="main-content <?php echo e(request()->routeIs('instructor.exams.create') ? 'no-sidebar' : ''); ?>" id="mainContent">
...
</script><?php /**PATH C:\xampp\htdocs\exam1\resources\views/layouts/Instructor/navigation.blade.php ENDPATH**/ ?>