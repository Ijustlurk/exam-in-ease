      ...
      <div class="modal-body" style="padding: 2rem;">
        ...
        <div class="mb-4">
          ...
          <div class="d-flex gap-2 flex-wrap">
            <a href="<?php echo e(route('admin.users.download-template', ['role' => 'student'])); ?>" class="btn btn-sm btn-outline-secondary" download>
              <i class="bi bi-file-earmark-spreadsheet me-1"></i> Student Template
            </a>
            <a href="<?php echo e(route('admin.users.download-template', ['role' => 'instructor'])); ?>" class="btn btn-sm btn-outline-secondary" download>
              <i class="bi bi-file-earmark-spreadsheet me-1"></i> Instructor Template
            </a>
            <a href="<?php echo e(route('admin.users.download-template', ['role' => 'programchair'])); ?>" class="btn btn-sm btn-outline-secondary" download>
        ...
        <!-- File Upload Form -->
        <form id="importUsersForm" action="<?php echo e(route('admin.users.import')); ?>" method="POST" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
...
</script><?php /**PATH C:\xampp\htdocs\exam1\resources\views/admin/users/partials/import-users-modal.blade.php ENDPATH**/ ?>