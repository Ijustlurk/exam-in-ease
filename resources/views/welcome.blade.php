            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="feature-card">
                        ...
                        <h4>Mobile App for Students</h4>
                        <p>Students can take exams anywhere, anytime with our dedicated mobile application. Seamless synchronization ensures a smooth examination experience.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="feature-card">
